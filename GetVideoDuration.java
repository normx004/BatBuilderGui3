...
//    and shells out via java 'exec' to run checkVid.bash (see
//    the "getDuration" method below for text of the script)
...
public class GetVideoDuration {
 ...
 public       GetVideoDuration( String vid) {
	 out("contructor got video path "+vid);
     vidPath = vid;
 }
 private void out(String s){
     System.out.println("GetVideoDuration: " + s);
 }
 ...
 public static void main(String[] args) {
     GetVideoDuration r = new GetVideoDuration(new String("/tmp/kg.mp4"));
